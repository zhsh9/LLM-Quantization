...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default=None, help="The name of this model was chosen as a suffix for storing the result tables of MMLU.")
    ...
    if not args.load and args.wbits < 16 and not args.nearest:
        tick = time.time()
        quantizers = qwen3_sequential(model, dataloader, DEV)
    ...
    if args.eval:
        ...
        eval_ours(model, tokenizer, model_name=f"{args.model_name}_{args.wbits}_{args.groupsize}")
